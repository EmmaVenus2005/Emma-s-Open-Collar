...
Flow(integer iWay,string sStr)
{
    ...
    } else if (g_iCurrentStep == 2)
    {
        ...
        if(iWay == DIALOG)
        {
            ...
            llMessageLinked(LINK_SET, RLV_CMD, "getinv:" + g_sBasePath + "=" + (string)g_iPrimaryChannel, NULL_KEY);
            llMessageLinked(LINK_SET, RLV_CMD, "getinv:" + g_sBasePath + "=" + (string)g_iSecondaryChannel, NULL_KEY);
    ...
    } else if (g_iCurrentStep == 5)
    {
        ...
        if(iWay == DIALOG)
        {
            ...
            llMessageLinked(LINK_SET, RLV_CMD, "getinvworn:" + g_sBasePath + "/" + llList2String(g_lFolders, g_iCurrentSubfolder) + "=" + (string)g_iPrimaryChannel, NULL_KEY);
            llMessageLinked(LINK_SET, RLV_CMD, "getinvworn:" + g_sBasePath + "/" + llList2String(g_lFolders, g_iCurrentSubfolder) + "=" + (string)g_iSecondaryChannel, NULL_KEY);
